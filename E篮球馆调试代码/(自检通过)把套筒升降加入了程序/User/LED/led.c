...
void LUN_GPIO_Config(void)
{
	...
	RCC_APB2PeriphClockCmd( Rwheel1_GPIO_CLK | Lwheel2_GPIO_CLK | NUM_GPIO_CLK, ENABLE);							//rcc 打开时钟，设置APB2总线。
	...
	GPIO_InitStruct.GPIO_Pin = NUM_GPIO_PIN;
	GPIO_Init(NUM_GPIO_PORT, &GPIO_InitStruct);
}
