#ifndef BSP__GENERALTIME3_H
#define BSP__GENERALTIME3_H
...
#define            GENERAL_TIM3_Period            599							/*  计算 PWM   波的公式 72M/( 10*72 )=100KHZ ， 占 空 比 为 GENERAL_TIM_CCR1/（GENERAL_TIM_PERIOD+1） = 50%。					*/
