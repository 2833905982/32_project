#ifndef _BSP_ADVANCETIM1_H
#define _BSP_ADVANCETIM1_H
...
#define            ADVANCE_TIM1_PERIOD            (8-1)					//调整周期
#define            ADVANCE_TIM1_PSC               (9-1)					//调整分频因子
#define            ADVANCE_TIM1_PULSE             4							//调整占空比
