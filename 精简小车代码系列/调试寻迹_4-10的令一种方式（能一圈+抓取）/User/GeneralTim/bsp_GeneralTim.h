#ifndef BSP__GENERALTIME_H
#define BSP__GENERALTIME_H
...
#define            GENERAL_TIM_Period            500							/*  计算 PWM   波的公式 72M/( 10*72 )=100KHZ ， 占 空 比 为 GENERAL_TIM_CCR1/（GENERAL_TIM_PERIOD+1） = 50%。					*/
...
#define            GENERAL_TIM4_Period            2000							/*  计算 PWM   波的公式 72M/( 10*72 )=100KHZ ， 占 空 比 为 GENERAL_TIM_CCR1/（GENERAL_TIM_PERIOD+1） = 50%。					*/
