...
//	delay_s(1);
//	houtui();
//	back_lukou(2);			//过了两个路口，回到米字路口
//  delay_s(1);
//	L_zhuanwan2(3);
//	delay_s(1);
//	qianjin();
// 	qianjin_lukou(1);				//到A点检测
//	delay_s(1);
//	qianjin();
//	qianjin_lukou(1);																//到绿色点，放物块
//	delay_s(1);
//	houtui();
//	back_lukou2(3);																//回到米字路口
//	delay_s(1);
//	R_zhuanwan2(3);
//	delay_s(1);
//	qianjin();
//	qianjin_lukou(2);															//到达红色点，放红色物块
//	//delay_s(1);
//	houtui();
//  back_lukou(3);																//回到米字路口
//	delay_s(1);
...
//	delay_s(1);
//	qianjin();
//	qianjin_lukou(1);														//到E点，抓取
//	//delay_s(1);
//	qianjin();
//	qianjin_lukou(1);															//到蓝色点
//	delay_s(1);
//	houtui();
//	back_lukou(3);																//退回到米字路口
//	delay_s(1);
//	L_zhuanwan2(3);
////	delay_s(1);
//	houtui();
//	back_lukou2(4);																//回到出发区，跑完
//	
//}
//void green(void)
//{
