...
#define    ADC_GPIO_CLK_C                  RCC_APB2Periph_GPIOC  
#define    ADC_PORT_C                      GPIOC
#define    ADC_GPIO_CLK_A                  RCC_APB2Periph_GPIOA  
...
#define    ADC_CHANNEL7                  ADC_Channel_4

#define    ADC_PIN8                      GPIO_Pin_5
#define    ADC_CHANNEL8                  ADC_Channel_5
